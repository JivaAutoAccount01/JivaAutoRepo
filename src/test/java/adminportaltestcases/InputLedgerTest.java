...
public class InputLedgerTest extends ElementManager {
	...
	public void inputLedger() throws Exception {
		...
		try {
			...
			try {
				userStoryDescription = "Jiva Web Portal - Enter Query details and View the Results";
				logUserStoryStart(userStoryDescription, "Jiva Web Portal - Enter Query details and View the Results");

...
public class MasterOriginSettingsTest extends ElementManager {
	...
	@Test
	public void originMasterSettings() throws Exception {
		...
		try {
			...
			try {
				userStoryDescription = "Jiva Web Portal - OriginSettings";
				logUserStoryStart(userStoryDescription, "Jiva Web Portal - OriginSettings");

				setoriginmaster.originSettings();

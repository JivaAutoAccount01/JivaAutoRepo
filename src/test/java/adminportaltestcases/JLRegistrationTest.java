...
public class JLRegistrationTest extends ElementManager {
	...
	@Test
	public void jivaJLCreate() throws Exception {
		...
		try {
			...
			try {
				userStoryDescription = "Jiva Web Portal - Enter JL details and Create New JL";
				logUserStoryStart(userStoryDescription, "Create New JL through Jiva Web Portal");

				jlcreatepage.jlCreate();
